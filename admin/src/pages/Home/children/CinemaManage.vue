  ...
  <div id="movie-manage">
    ...
    <div class="top">
      ...
      <el-col :span="2" :offset="1">
        <el-button type="primary" size="small">添加影院</el-button>
      </el-col>
    </div>
    <!-- 表格 -->
    <div class="movie-table">
      <el-table border width="100%">
        <el-table-column label="影院 ID" align="center" width="120px" prop="cinema_id"></el-table-column>
        <el-table-column label="影院名" align="center" show-overflow-tooltip prop="cinema_name"></el-table-column>
        <el-table-column label="联系电话" align="center"
        width="200px" prop="cinema_phone"></el-table-column>
        <el-table-column label="详细地址" align="center" show-overflow-tooltip  prop="specified_address"></el-table-column>
